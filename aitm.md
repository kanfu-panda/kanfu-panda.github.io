...
<div class="about-grid">
    <div class="about-card">
        ...
        <p><strong>v0.5.3</strong> · macOS Apple Silicon (aarch64) · 6.3 MB</p>
        <p style="margin-top: 1rem;">
            <a href="/assets/downloads/aitm_0.5.3_aarch64.dmg" class="cta-button" download>Download dmg →</a>
        </p>
    </div>
    <div class="about-card">
        <h3>Verify integrity (recommended)</h3>
        <p>After downloading, check the SHA256:</p>
        <pre><code>shasum -a 256 ~/Downloads/aitm_0.5.3_aarch64.dmg</code></pre>
        <p>It should match the <a href="/assets/downloads/aitm_0.5.3_aarch64.dmg.sha256">official checksum</a> exactly.</p>
    </div>
</div>
