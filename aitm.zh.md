...
permalink: /aitm/
lang: zh
description: aitm — 一个把 AI 能力做进终端的桌面应用，支持 macOS 与 Windows。让 AI 直接读文件、看命令历史、按需帮你执行命令，所有高危操作都要你点头确认。
---
...
<div class="about-grid">
    <div class="about-card">
        ...
        <p style="margin-top: 1rem;">
            <a href="/assets/downloads/aitm_0.9.1_aarch64.dmg" class="cta-button" download>下载 .dmg →</a>
        </p>
    ...
    <div class="about-card">
        ...
        <p>Intel / AMD 64 位</p>
        <p style="margin-top: 1rem;">
            <a href="/assets/downloads/aitm_0.9.1_x64_en-US.msi" class="cta-button" download>下载 .msi · 7.2 MB →</a>
        </p>
        <p style="margin-top: 0.5rem; font-size: 0.85em;">
            或 <a href="/assets/downloads/aitm_0.9.1_x64-setup.exe" download>NSIS .exe · 5.5 MB</a> ·
    ...
    <div class="about-card">
        ...
        <p style="margin-top: 1rem;">
            <a href="/assets/downloads/aitm_0.9.1_arm64_en-US.msi" class="cta-button" download>下载 .msi · 6.8 MB →</a>
        </p>
        <p style="margin-top: 0.5rem; font-size: 0.85em;">
            或 <a href="/assets/downloads/aitm_0.9.1_arm64-setup.exe" download>NSIS .exe · 4.9 MB</a> ·
