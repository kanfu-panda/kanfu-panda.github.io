...
<div class="about-grid">
    <div class="about-card">
        ...
        <p style="margin-top: 1rem;">
            <a href="/assets/downloads/aitm_0.5.10_aarch64.dmg" class="cta-button" download>下载 dmg →</a>
        </p>
    </div>
    <div class="about-card">
        <h3>校验完整性（推荐）</h3>
        ...
        <p>结果应与 <a href="/assets/downloads/aitm_0.5.10_aarch64.dmg.sha256">官方校验和</a> 完全一致。</p>
    </div>
</div>
