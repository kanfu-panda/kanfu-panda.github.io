...
- **関連記事**：{% include project-posts.html project="aitm" mode="count" %}
...
- **関連記事**：{% include project-posts.html project="pdlc" mode="count" %}
...
- **関連記事**：{% include project-posts.html project="arcade" mode="count" %}
