...
## aitm
- **Stack**: Tauri 2 + React 19 + Rust + TypeScript, Apache-2.0
...
- **Summary**: This very site. Pure static, built with Jekyll, hosted on GitHub Pages. Trilingual (English / Chinese / Japanese) with a CSP + SRI security baseline.
