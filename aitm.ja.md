...
<div class="about-grid">
    <div class="about-card">
        ...
        <p style="margin-top: 1rem;">
            <a href="/assets/downloads/aitm_0.5.3_aarch64.dmg" class="cta-button" download>dmg をダウンロード →</a>
        </p>
    </div>
    <div class="about-card">
        <h3>整合性の検証（推奨）</h3>
        ...
        <p>結果は <a href="/assets/downloads/aitm_0.5.3_aarch64.dmg.sha256">公式チェックサム</a> と完全に一致するはずです。</p>
    </div>
</div>
